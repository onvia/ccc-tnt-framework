...
export let $ProtoBuf : typeof GProtoBuf = ProtoBuf;


class Util{
    static IS_NODE: boolean;
    static fetch(path, callback?: Runnable);
}

class Message{
    static encode(obj: any): ByteBuffer;
    static decode(data: any): any;
}
class Builder{
    build(path?: string): any;
    lookup(path, excludeNonNamespace?): typeof Message;
}
class GProtoBuf{
    static Message: typeof Message;
    static Builder: typeof Builder;
    static Util: typeof Util;
    static newBuilder(options?: any);
    static loadJsonFile(filename: string, callback: Runnable, builder: ProtoBuf.Builder): Builder;
    static loadJson(json, builder, filename): Builder;
    static loadProtoFile(filename, callback: (err,builder: Builder)=> void, builder?: Builder): Builder;
    static protoFromString(proto, builder, filename): Builder;
    static loadProto(proto, builder?, filename?): Builder;
}